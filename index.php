...
$result = mysqli_query($conn, "
    SELECT movies.*, platforms.nama_platform
    FROM movies
    LEFT JOIN platforms ON movies.platform_id = platforms.id
    ...
    <div class="page-wrap">
        <div class="topbar">
            ...
            <div class="topbar-actions">
                <a href="tambah.php" class="btn primary">+ Tambah Watchlist</a>
                <a href="platforms.php" class="btn info">Kelola Platform</a>
        ...
        <div class="table-card">
            <table>
                ...
                <tbody>
                    <?php if (mysqli_num_rows($result) > 0): ?>
                        ...
                        <?php while ($row = mysqli_fetch_assoc($result)): ?>
                            <tr>
                                ...
                                <td><?php echo $row['nama_platform'] ? htmlspecialchars($row['nama_platform']) : '<span class="text-muted">Belum dipilih</span>'; ?></td>
                                <td class="actions">
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="8" class="empty">Belum ada data watchlist.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
